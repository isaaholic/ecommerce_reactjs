    ...
    <form className="flex w-screen justify-center items-center h-screen">
      <div className="flex w-screen items-center flex-col">
        ...
        <div className="flex justify-center w-full mt-[30px]">
          <button className="h-[56px] w-full max-w-[375px] py-[12px] px-[26px] bg-[#5ECE7B] text-white" type="submit">Sign Up</button>
        </div>
        <div className="flex justify-center w-full mt-[12px]">
          <p className="text-[#0F6450] font-semibold">Do you have account? <span className="underline">Log in</span></p>
        </div>
      </div>
    </form>
  );
